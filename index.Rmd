...
operativo. Hacer click ahí, descargar e instalar. Si no están en una computadora
compartida, también será conveniente instalar un programa para recordar la 
contraseña del servicio de git provisto por [GitHub](https://github.com). Si 
están en Windows, deben descargar Git Credential Manager for Windows. Ir a 
https://github.com/Microsoft/Git-Credential-Manager-for-Windows/releases/tag/v.1.6.0
, desplazarse hasta *Downloads* y descargar el ejecutable (la primera opción).
Instalar. Ahora, solo deberán ingresar su usuario y contraseña solo la primera
vez que Git se los solicite.

A continuación debemos instalar RStudio. Para esto, debemos navegar hasta
https://www.rstudio.com/products/rstudio/download2/ y poner